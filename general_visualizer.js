...
///////// going from URL data --> model path /////////
async function getModelPath() {
  ...
  try {
    ...
    // Build path to your actual file
    return `models/${folder}/${folder}_${id}.glb`;
...
getModelPath().then((modelPath) => {
  if (!modelPath) {
    loadingDiv.innerText = "Invalid model request";
    return;
  }
//////////////////////////////
// LOADING OVERLAY
